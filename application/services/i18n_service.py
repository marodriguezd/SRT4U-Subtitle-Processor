...
class I18nService(QObject):
    ...
    TRANSLATIONS: Dict[str, Dict[str, str]] = {
        ...
        "en": {
            ...
            "completed.btn_to_preview": "View in Studio",
            ...
            "about.restr_1": "Attribution (BY): Credit the author (Miguel Ángel Rodríguez Dalí)",
        ...
        "es": {
            ...
            "completed.btn_to_preview": "Ver en vista previa",
            ...
            "about.restr_1": "Atribución (BY): Dar crédito al autor (Miguel Ángel Rodríguez Dalí)",
        ...
        "pt": {
            ...
            "completed.btn_to_preview": "Ver no Estúdio",
            ...
            "about.restr_1": "Atribuição (BY): Dar crédito ao autor (Miguel Ángel Rodríguez Dalí)",
        ...
        "de": {
            ...
            "completed.btn_to_preview": "In Vorschau ansehen",
            ...
            "about.restr_1": "Namensnennung (BY): Urheber angeben (Miguel Ángel Rodríguez Dalí)",
        ...
        "it": {
            ...
            "completed.btn_to_preview": "Vedi in Studio",
            ...
            "about.restr_1": "Attribuzione (BY): Dare credito all'autore (Miguel Ángel Rodríguez Dalí)",
        ...
        "zh-CN": {
            ...
            "completed.btn_to_preview": "在工作区预览",
            ...
            "about.restr_1": "署名 (BY)：必须注明原作者姓名 (Miguel Ángel Rodríguez Dalí)",
